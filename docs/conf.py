...
latex_documents = [
  (master_doc, 'bincopy.tex', u'bincopy Documentation',
...
man_pages = [
    (master_doc, 'bincopy', u'bincopy Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'bincopy', u'bincopy Documentation',
   author, 'bincopy', 'One line description of project.',
   'Miscellaneous'),
]
